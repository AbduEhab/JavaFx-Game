...
public class M1PublicTests {
	...
	public void testConstructor0Minion() throws Exception {
		Class[] inputs = { String.class, int.class, Class.forName(rarityPath), int.class, int.class, boolean.class,
	...
	public void testConstructorInitialization1700Warlock() throws Exception {
		...
		int int00 = 0;
		String[] names = { "name", "currentHP", "heroPowerUsed", "totalManaCrystals", "currentManaCrystals",
				"fatigueDamage" };
	...
	public void testConstructorInitialization3700Minion() throws Exception {
		...
		boolean boolean02 = false;
		Object minion00 = Class.forName(minionPath)
				.getConstructor(String.class, int.class, Class.forName(rarityPath), int.class, int.class, boolean.class,
						boolean.class, boolean.class)
				.newInstance(string00, int75, rarity04, int83, int41, boolean01, boolean01, boolean02);
		int int10 = 10;
		String[] names = { "attack", "maxHP", "currentHP", "taunt", "divine", "sleeping", "attacked", "name",
				"manaCost", "rarity" };
		Object[] values = { int83, int41, int41, boolean01, boolean01, boolean01, boolean02, string00, int10,
				rarity04 };
	...
	public void testConstructorInitialization3800Icehowl() throws Exception {
		...
		String[] names = { "attack", "maxHP", "currentHP", "taunt", "divine", "sleeping", "attacked", "name",
				"manaCost", "rarity" };
		Object[] values = { int10, int10, int10, boolean02, boolean02, boolean02, boolean02, icehowlString, int09,
				rarity04 };
	...
	public void testConstructorInitialization4100NotYourTurnException() throws Exception {
		String string00 = "d02";
		Object notYourTurnException00 = Class.forName(notYourTurnExceptionPath).getConstructor(String.class)
				.newInstance(string00);
	...
	public void testConstructorInitialization4200NotSummonedException() throws Exception {
		String string00 = "d02";
		Object notSummonedException00 = Class.forName(notSummonedExceptionPath).getConstructor(String.class)
				.newInstance(string00);
	...
	public void testConstructorInitialization4400InvalidTargetException() throws Exception {
		String string00 = "d02";
		Object invalidTargetException00 = Class.forName(invalidTargetExceptionPath).getConstructor(String.class)
				.newInstance(string00);
	...
	public void testConstructorInitialization4500HeroPowerAlreadyUsedException() throws Exception {
		String string00 = "d02";
		Object heroPowerAlreadyUsedException00 = Class.forName(heroPowerAlreadyUsedExceptionPath)
				.getConstructor(String.class).newInstance(string00);
	...
	public void testConstructorInitialization4501HeroPowerAlreadyUsedException() throws Exception {
		Object heroPowerAlreadyUsedException01 = Class.forName(heroPowerAlreadyUsedExceptionPath).getConstructor()
				.newInstance();
	...
	public void testConstructorInitialization4601FullHandException() throws Exception {
		...
		Object fullHandException01 = Class.forName(fullHandExceptionPath).getConstructor(Class.forName(cardPath))
				.newInstance(multiShot00);
	...
	public void testConstructorInitialization4800CannotAttackException() throws Exception {
		String string00 = "d02";
		Object cannotAttackException00 = Class.forName(cannotAttackExceptionPath).getConstructor(String.class)
				.newInstance(string00);
	...
	@Test(timeout = 10000)
	public void testInstanceVariablePresentInClassFatigueDamageHandFieldDeckManaCrystalsCurrentTotalHeroPowerUsedHPName()
			throws Exception {
	...
	@Test(timeout = 1000)
	public void testGetterLogicForInstanceVariableNameshadowWordDeath00shadowWordDeathStringInClassCard()
			throws Exception {
		Object shadowWordDeath00 = Class.forName(shadowWordDeathPath).getConstructor().newInstance();
	...
	@Test(timeout = 10000)
	public void testSetterForInstanceVariableExistsInClassFatigueDamageHandFieldDeckManaCrystalsCurrentTotalHeroPowerUsedHPName()
			throws Exception {
	...
	public void testSetterForInstanceVariableExistsInClassRarityManaCostName() throws Exception {
		...
		testSetterMethodExistsInClass(Class.forName(shadowWordDeathPath), "setRarity", Class.forName(rarityPath),
				false);
		testSetterMethodExistsInClass(Class.forName(sealOfChampionsPath), "setRarity", Class.forName(rarityPath),
				false);
		...
		testSetterMethodExistsInClass(Class.forName(curseOfWeaknessPath), "setRarity", Class.forName(rarityPath),
				false);
	...
	@Test(timeout = 10000)
	public void testGetterForInstanceVariableExistsInClassFatigueDamageHandFieldDeckManaCrystalsCurrentTotalHeroPowerUsedHPName()
			throws Exception {
	...
	public void testGetterForInstanceVariableExistsInClassRarityManaCostName() throws Exception {
		...
		testGetterMethodExistsInClass(Class.forName(shadowWordDeathPath), "getRarity", Class.forName(rarityPath),
				false);
		testGetterMethodExistsInClass(Class.forName(sealOfChampionsPath), "getRarity", Class.forName(rarityPath),
				false);
		...
		testGetterMethodExistsInClass(Class.forName(curseOfWeaknessPath), "getRarity", Class.forName(rarityPath),
				false);
	...
	public void testSetterLogicForInstanceVariableAttackminion00int00InClassMinion() throws Exception {
		...
		Object minion00 = Class.forName(minionPath)
				.getConstructor(String.class, int.class, Class.forName(rarityPath), int.class, int.class, boolean.class,
						boolean.class, boolean.class)
				.newInstance(string00, int52, rarity01, int65, int18, boolean02, boolean01, boolean01);
	...
	private void testGetAllNeutralMinionsMethod(ArrayList<Object> correctMinions, ArrayList<Object> minions)
			throws IOException, ClassNotFoundException, IllegalArgumentException, IllegalAccessException,
			NoSuchFieldException, SecurityException {

		assertEquals("Wrong number of Minions read from the CSV file using getAllNeutralMinion()",
	...
	public void equals(Object correct, Object check) throws ClassNotFoundException, IllegalArgumentException,
		...
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong name.", name.get(correct),
				name.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong manaCost.", manaCost.get(correct),
				manaCost.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong rarity.", rarity.get(correct),
				rarity.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong attack.", attack.get(correct),
				attack.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong maxHP.", maxHP.get(correct),
				maxHP.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong currentHP.", currentHP.get(correct),
				currentHP.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong taunt.", taunt.get(correct),
				taunt.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong divine.", divine.get(correct),
				divine.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong sleeping.", sleeping.get(correct),
				sleeping.get(check));
		assertEquals("Minion " + name.get(correct) + " initialised with the wrong attacked.", attacked.get(correct),
				attacked.get(check));
	}

	@Test(timeout = 1000)
	public void testIceHowlInstantiation()
	...
	public void testCountOfCardsFromGetNeutralMinionsMethod()
		...
		Object goldshire = minionClass.getConstructor(minionCons).newInstance("Goldshire Footman", 1, rarityBasic, 1, 2,
				true, false, false);
		Object stonetusk = minionClass.getConstructor(minionCons).newInstance("Stonetusk Boar", 1, rarityBasic, 1, 1,
				false, false, true);
		Object bloodfen = minionClass.getConstructor(minionCons).newInstance("Bloodfen Raptor", 2, rarityBasic, 3, 2,
				false, false, false);
		Object frostwolf = minionClass.getConstructor(minionCons).newInstance("Frostwolf Grunt", 2, rarityBasic, 2, 2,
				true, false, false);
		Object wolfrider = minionClass.getConstructor(minionCons).newInstance("Wolfrider", 3, rarityBasic, 3, 1, false,
				false, true);
		Object chilwind = minionClass.getConstructor(minionCons).newInstance("Chilwind Yeti", 4, rarityBasic, 4, 5,
				false, false, false);
		Object boulderfist = minionClass.getConstructor(minionCons).newInstance("Boulderfist Ogre", 6, rarityBasic, 6,
				7, false, false, false);
		Object core = minionClass.getConstructor(minionCons).newInstance("Core Hound", 7, rarityBasic, 9, 5, false,
				false, false);
		Object argent = minionClass.getConstructor(minionCons).newInstance("Argent Commander", 6, rarityRare, 4, 2,
				false, true, true);
		Object sunwalker = minionClass.getConstructor(minionCons).newInstance("Sunwalker", 6, rarityRare, 4, 5, true,
				true, false);
		Object chromaggus = minionClass.getConstructor(minionCons).newInstance("Chromaggus", 8, rarityLegendary, 6, 8,
				false, false, false);
		Object lichKing = minionClass.getConstructor(minionCons).newInstance("The LichKing", 8, rarityLegendary, 10, 10,
				true, false, false);
		Object icehowl = minionClass.getConstructor(minionCons).newInstance("Icehowl", 9, rarityLegendary, 10, 10,
				false, false, true);
		Object colossus = minionClass.getConstructor(minionCons).newInstance("Colossus of the Moon", 10,
				rarityLegendary, 10, 10, false, true, false);
		...
		assertEquals("GetNeutralMinions method returns the wrong count of cards", 15,
				((ArrayList<Object>) heroClass.getDeclaredMethod("getNeutralMinions", ArrayList.class, int.class)
						.invoke(heroClass, correctMinions, 15)).size());
	}

	@Test(timeout = 1000)
	public void testBasicRareCopiesCount()
			throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException, ClassNotFoundException {
		...
		ArrayList<Object> deck = (ArrayList<Object>) heroClass
				.getDeclaredMethod("getNeutralMinions", ArrayList.class, int.class)
		...
		for (Object o : deck) {
			...
			if (copiesGoldshire > 2 || copiesStonetusk > 2 || copiesBloodfen > 2 || copiesFrostwolf > 2
					|| copiesWolfrider > 2 || copiesChilwind > 2 || copiesBoulderfist > 2 || copiesCore > 2
	...
	@Test(timeout = 1000)
	public void testLegendaryCopies() throws InstantiationException, IllegalAccessException, IllegalArgumentException,
		...
		for (Object o : deck) {
			...
			if (copiesChroma > 1 || copiesLich > 1 || copiesIcehowl > 1 || copiesMoon > 1)
	...
	public void testGetNeutralMinionRandomization()
		...
		if (((ArrayList<Object>) heroClass.getDeclaredMethod("getNeutralMinions", ArrayList.class, int.class)
				.invoke(heroClass, correctMinions, 15))
						.equals(((ArrayList<Object>) heroClass
								.getDeclaredMethod("getNeutralMinions", ArrayList.class, int.class)
								.invoke(heroClass, correctMinions, 15))))
	...
	public void testNumberOfNeutralMinionsForHunter()
		...
		ArrayList<Object> hunterDeck = (ArrayList<Object>) getDeck.invoke(oHunter);

		int neutralMinionscount = 0;

		for (Object card : hunterDeck) {
			if (card.getClass() == iceHowlClass || (card.getClass() == minionClass
					&& !(card.getClass().getMethod("getName").invoke(card).equals("King Krush"))))
				neutralMinionscount++;
		}
		assertEquals("A Hunter's deck should contatin 15 neutral minions", 15, neutralMinionscount);
	...
	public void testNumberOfNeutralMinionsForMage()
		...
		for (Object card : mageDeck) {
			if (card.getClass() == iceHowlClass || (card.getClass() == minionClass
					&& !(card.getClass().getMethod("getName").invoke(card).equals("Kalycgos"))))
				neutralMinionscount++;
		}
		assertEquals("A Mage's deck should contatin 13 neutral minions", 13, neutralMinionscount);
	}
	...
	public void testNumberOfNeutralMinionsForPaladin()
		...
		Method getDeck = oHunter.getClass().getMethod("getDeck");
		ArrayList<Object> paladinDeck = (ArrayList<Object>) getDeck.invoke(oPaladin);

		int neutralMinionscount = 0;

		for (Object card : paladinDeck) {
			if (card.getClass() == iceHowlClass || (card.getClass() == minionClass
					&& !(card.getClass().getMethod("getName").invoke(card).equals("Tirion Fordring"))))
				neutralMinionscount++;
		}
		assertEquals("A Paladin's deck should contatin 15 neutral minions", 15, neutralMinionscount);
	}
	...
	public void testNumberOfNeutralMinionsForPriest()
		...
		Method getDeck = oHunter.getClass().getMethod("getDeck");
		ArrayList<Object> priestDeck = (ArrayList<Object>) getDeck.invoke(oPriest);

		int neutralMinionscount = 0;

		for (Object card : priestDeck) {
			if (card.getClass() == iceHowlClass || (card.getClass() == minionClass
					&& !(card.getClass().getMethod("getName").invoke(card).equals("Prophet Velen"))))
				neutralMinionscount++;
		}
		assertEquals("A Priest's deck should contatin 13 neutral minions", 13, neutralMinionscount);
	}
	...
	public void testNumberOfNeutralMinionsForWarlock()
		...
		Method getDeck = oHunter.getClass().getMethod("getDeck");
		ArrayList<Object> warlockDeck = (ArrayList<Object>) getDeck.invoke(oWarlock);

		int neutralMinionscount = 0;

		for (Object card : warlockDeck) {
			if (card.getClass() == iceHowlClass || (card.getClass() == minionClass
					&& !(card.getClass().getMethod("getName").invoke(card).equals("Wilfred Fizzlebang"))))
				neutralMinionscount++;
		}
		assertEquals("A Warlock's deck should contatin 13 neutral minions", 13, neutralMinionscount);
	}
	...
	public void testSpecialLegendaryMinionForHunter()
		...
		Object oHunter = hunterClass.getConstructor().newInstance();
		Object krush = minionClass.getConstructor(minionCons).newInstance("King Krush", 9, rarityLegendary, 8, 8, false,
				false, true);
	...
	public void testSpecialLegendaryMinionForMage()
		...
		Object kalycgos = minionClass.getConstructor(minionCons).newInstance("Kalycgos", 10, rarityLegendary, 4, 12,
				false, false, false);
	...
	public void testSpecialLegendaryMinionForPaladin()
		...
		Object tirion = minionClass.getConstructor(minionCons).newInstance("Tirion Fordring", 4, rarityLegendary, 6, 6,
				true, true, false);
	...
	public void testSpecialLegendaryMinionForPriest()
		...
		Object velen = minionClass.getConstructor(minionCons).newInstance("Prophet Velen", 7, rarityLegendary, 7, 7,
				false, false, false);
	...
	public void testSpecialLegendaryMinionForWarlock()
		...
		Object oHunter = hunterClass.getConstructor().newInstance();
		Object oWarlock = warlockClass.getConstructor().newInstance();
		Object wilfred = minionClass.getConstructor(minionCons).newInstance("Wilfred Fizzlebang", 6, rarityLegendary, 4,
				4, false, false, false);
	...
	@Test(timeout = 1000)
	public void testCorrectSpellsForHunter()
			throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
		Class hunterClass = Class.forName(hunterPath);
		...
		for (Object card : hunterDeck) {
			...
			else if (card.getClass() == cureOfWeaknessClass || card.getClass() == divineSpiritClass
					|| card.getClass() == flameStrikeClass || card.getClass() == holyNovaClass
					|| card.getClass() == levelUpClass || card.getClass() == polymorphClass
					|| card.getClass() == pyroblastClass || card.getClass() == sealofChampionsClass
					|| card.getClass() == shadowWordDeathClass || card.getClass() == siphonSoulClass
					|| card.getClass() == twistingNetherClass)
				fail("Hunter's deck should contain ONLY KillCommand and MultiShot spells "
						+ card.getClass().getMethod("getName") + " spell is found in the Hunter's deck");

		}
		assertEquals("Hunter's deck contains wrong number of KillCommand Spell", 2, killCommandcount);
		assertEquals("Hunter's deck contains wrong number of MultiShot Spell", 2, multiShotcount);
	}

	@Test(timeout = 1000)
	public void testCorrectSpellsForMage()
			throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
		Class hunterClass = Class.forName(hunterPath);
		Class mageClass = Class.forName(magePath);
		...
		for (Object card : mageDeck) {
			if (card.getClass() == polymorphClass)
				...
				pyroBlastcount++;
					...
					|| card.getClass() == killCommandClass || card.getClass() == holyNovaClass
					|| card.getClass() == levelUpClass || card.getClass() == multiShotClass
					|| card.getClass() == sealofChampionsClass || card.getClass() == shadowWordDeathClass
					|| card.getClass() == siphonSoulClass || card.getClass() == twistingNetherClass)
				fail("Mage's deck should contain ONLY Polymorph, FlameStrike and PyroBlast spells "
						+ card.getClass().getMethod("getName") + " spell is found in the Mage's deck");
		}

		assertEquals("Mage's deck contains wrong number of Polymorph Spell", 2, polymorphcount);
		assertEquals("Mage's deck contains wrong number of FlameStrike Spell", 2, flameStrikecount);
		assertEquals("Mage's deck contains wrong number of PyroBlast Spell", 2, pyroBlastcount);

	}

	@Test(timeout = 1000)
	public void testCorrectSpellsForPaladin()
			throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		for (Object card : paladinDeck) {
			if (card.getClass() == sealofChampionsClass)
				...
				levelUpcount++;
					...
					|| card.getClass() == killCommandClass || card.getClass() == holyNovaClass
					|| card.getClass() == flameStrikeClass || card.getClass() == multiShotClass
					|| card.getClass() == polymorphClass || card.getClass() == shadowWordDeathClass
					|| card.getClass() == siphonSoulClass || card.getClass() == twistingNetherClass
					|| card.getClass() == pyroblastClass)
				fail("Paladin's deck should contain ONLY SealOfChampions and LevelUp spells "
						+ card.getClass().getMethod("getName") + " spell is found in the Paladin's deck");
		}

		assertEquals("Paladin's deck contains wrong number of SealOfChampions Spell", 2, sealOfChampioncount);
		assertEquals("Paladin's deck contains wrong number of LevelUps Spell", 2, levelUpcount);
	}

	@Test(timeout = 1000)
	public void testCorrectSpellsForPriest()
			throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
		Class hunterClass = Class.forName(hunterPath);
		Class priestClass = Class.forName(priestPath);
		...
		for (Object card : priestDeck) {
			if (card.getClass() == divineSpiritClass)
				...
				shadowWordcount++;
			else if (card.getClass() == cureOfWeaknessClass || card.getClass() == levelUpClass
					|| card.getClass() == killCommandClass || card.getClass() == sealofChampionsClass
					|| card.getClass() == flameStrikeClass || card.getClass() == multiShotClass
					|| card.getClass() == polymorphClass || card.getClass() == siphonSoulClass
					|| card.getClass() == twistingNetherClass || card.getClass() == pyroblastClass)
				fail("Priest's deck should contain ONLY DivineSpirit, HolyNova and ShadowWordDeath spells. "
						+ card.getClass().getMethod("getName") + " spell is found in the Priest's deck");
		}

		assertEquals("Priest's deck contains wrong number of DivineSpirit Spell", 2, divineSpiritcount);
		assertEquals("Priest's deck contains wrong number of HolyNova Spell", 2, holyNovacount);
		assertEquals("Priest's deck contains wrong number of ShadowWordDeath Spell", 2, shadowWordcount);
	}

	@Test(timeout = 1000)
	public void testCorrectSpellsForWarlock()
			throws ClassNotFoundException, InstantiationException, IllegalAccessException, IllegalArgumentException,
			InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		for (Object card : warlockDeck) {
			...
			else if (card.getClass() == divineSpiritClass || card.getClass() == levelUpClass
					|| card.getClass() == killCommandClass || card.getClass() == sealofChampionsClass
					|| card.getClass() == flameStrikeClass || card.getClass() == multiShotClass
					|| card.getClass() == polymorphClass || card.getClass() == pyroblastClass
					|| card.getClass() == holyNovaClass || card.getClass() == shadowWordDeathClass)
				fail("Warlock's deck should contain ONLY CurseOfWeakness, SiphonSoul and TwistingNether spells. "
						+ card.getClass().getMethod("getName") + " spell is found in the Warlock's deck");
		}

		assertEquals("Warlock's deck contains wrong number of CurseOfWeakness Spell", 2, curseOfWeaknesscount);
		assertEquals("Warlock's deck contains wrong number of SiphonSoul Spell", 2, siphonSoulcount);
		assertEquals("Warlock's deck contains wrong number of TwistingNether Spell", 2, tswistingNethercount);

	}

	@Test(timeout = 1000)
	public void testHunterDeckShuffle() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		ArrayList<Object> hunterDeck1 = (ArrayList<Object>) getDeck.invoke(oHunter);
		boolean[] change = new boolean[20];
		for (int i = 0; i < 10; i++) {
			Object oHunter2 = hunterClass.getConstructor().newInstance();
			ArrayList<Object> hunterDeck2 = (ArrayList<Object>) getDeck.invoke(oHunter2);
			for (int j = 0; j < hunterDeck1.size(); j++) {
				if (((hunterDeck1.get(j).getClass() == minionClass || hunterDeck1.get(j).getClass() == iceHowlClass))
	...
	@Test
	public void testMageDeckShuffle() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Class spellClass = Class.forName(spellPath);
		Class minionClass = Class.forName(minionPath);
		Class iceHowlClass = Class.forName(icehowlPath);
		...
		for (int i = 0; i < 10; i++) {
			...
			ArrayList<Object> mageDeck2 = (ArrayList<Object>) getDeck.invoke(oMage2);
			for (int j = 0; j < mageDeck1.size(); j++) {
				if (((mageDeck1.get(j).getClass() == minionClass || mageDeck1.get(j).getClass() == iceHowlClass))
	...
	@Test
	public void testPaladinDeckShuffle() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Class spellClass = Class.forName(spellPath);
		Class minionClass = Class.forName(minionPath);
		Class iceHowlClass = Class.forName(icehowlPath);
		...
		Method getDeck = oHunter.getClass().getMethod("getDeck");
		boolean[] change = new boolean[20];
		ArrayList<Object> paladinDeck1 = (ArrayList<Object>) getDeck.invoke(oPaladin);
		for (int i = 0; i < 10; i++) {
			Object oPaladin2 = paladinClass.getConstructor().newInstance();
			ArrayList<Object> paladinDeck2 = (ArrayList<Object>) getDeck.invoke(oPaladin2);
			for (int j = 0; j < paladinDeck1.size(); j++) {
				if (((paladinDeck1.get(j).getClass() == minionClass || paladinDeck1.get(j).getClass() == iceHowlClass))
	...
	@Test
	public void testPriestDeckShuffle() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Class spellClass = Class.forName(spellPath);
		Class minionClass = Class.forName(minionPath);
		Class iceHowlClass = Class.forName(icehowlPath);
		...
		Method getDeck = oHunter.getClass().getMethod("getDeck");
		boolean[] change = new boolean[20];
		ArrayList<Object> priestDeck1 = (ArrayList<Object>) getDeck.invoke(oPriest);
		for (int i = 0; i < 10; i++) {
			Object oPriest2 = priestClass.getConstructor().newInstance();
			ArrayList<Object> priestDeck2 = (ArrayList<Object>) getDeck.invoke(oPriest2);
			for (int j = 0; j < priestDeck1.size(); j++) {
				if (((priestDeck1.get(j).getClass() == minionClass || priestDeck1.get(j).getClass() == iceHowlClass))
	...
	@Test
	public void testWarlockDeckShuffle() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
			IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
		Class spellClass = Class.forName(spellPath);
		Class minionClass = Class.forName(minionPath);
		Class iceHowlClass = Class.forName(icehowlPath);
		...
		Method getDeck = oHunter.getClass().getMethod("getDeck");
		boolean[] change = new boolean[20];
		ArrayList<Object> warlockDeck1 = (ArrayList<Object>) getDeck.invoke(oWarlock);
		for (int i = 0; i < 10; i++) {
			Object oWarlock2 = warlockClass.getConstructor().newInstance();
			ArrayList<Object> warlockDeck2 = (ArrayList<Object>) getDeck.invoke(oWarlock2);
			for (int j = 0; j < warlockDeck1.size(); j++) {
				if (((warlockDeck1.get(j).getClass() == minionClass || warlockDeck1.get(j).getClass() == iceHowlClass))
...
// ############################################# Special Game
	...
	public void testGetNeutralMinionsisFinal() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
		...
		assertTrue("Method \"getNeutralMinions\" should not be overridden by any subclass.",
				Modifier.isFinal(m.getModifiers()));
	}
	...
	public void testConstructorInitialization4900Game() throws Exception {
		...
		int c2 = 0;
		for (int i = 0; i < 50; i++) {
			Object game00 = Class.forName(gamePath).getConstructor(Class.forName(heroPath), Class.forName(heroPath))
					.newInstance(paladin00, warlock00);
...
// ############################################# Helper methods
	...
	private boolean testConstructorInitializationWithRandom(Object createdObject, String[] names, Object[] values)
	...
	private void testConstructorInitializationException(Object createdObject, String message)
			throws NoSuchMethodException, SecurityException, IllegalArgumentException, IllegalAccessException,
		...
		assertEquals("The Exception constructor of the " + createdObject.getClass().getSimpleName()
				+ " class should initialize the message correctly.", message, messageFiled.get(createdObject));
	}
