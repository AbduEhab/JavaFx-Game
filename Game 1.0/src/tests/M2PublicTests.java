...
public class M2PublicTests {
	...
	public void testMinionAttacksHeroUpdatingAttacked() throws Exception {
		...
		assertEquals("The attaker minion should update the attacked flag when attaking a hero.", true,
				attackerMinion.isAttacked());
	}
	...
	public void testMinionAttacksMinionOneNotLosingDivine() throws Exception {
		...
		assertEquals("The attaker minion should not lose divine if the target Minion has 0 attack.", true,
				attackerMinion.isDivine());
	}
	...
	public void testMinionListenerHasOnMinionDeath() throws Exception {
		testExistsInClass(Class.forName("model.cards.minions.MinionListener"), "onMinionDeath", true, void.class,
				Minion.class);
	}
...
System.out.println();
	...
	public void testLevelUpAffectingField() throws Exception {
		...
		for (int i = 0; i < 3; i++) {
			...
			assertEquals("LevelUp should affect the current HP of Silver Hand Recruit.", 2,
					field.get(i).getCurrentHP());
		}
		assertEquals("LevelUp should not affect the attack of minions which are not Silver Hand Recruit.", 1,
				field.get(3).getAttack());
		assertEquals("LevelUp should not affect the max HP of minions which are not Silver Hand Recruit.", 1,
				field.get(3).getMaxHP());
		assertEquals("LevelUp should not affect the current HP of minions which are not Silver Hand Recruit.", 1,
				field.get(3).getCurrentHP());
	}
	...
	public void testMultiShotAffectingOpponentFieldWithOneTarget() throws Exception {
		...
		assertEquals("MultiShot should damage the minion with the right amount.", 6,
				opponentField.get(0).getCurrentHP());
	}
	...
	public void testMultiShotAffectingOpponentFieldWithFiveKillableTargets() throws Exception {
		for (int i = 0; i < 50; i++) {
			...
			assertEquals("In case of a field filled with minions with HP 3, only 2 of them should die.", 3,
					minionListener.getField().size());
		}
	...
	public void testTwistingNetherEffect() throws Exception {
		...
		assertTrue("TwistingNether sould kill all minions on both fields.",
				hero1.getField().size() + hero2.getField().size() == 0);
	}
	...
	public void testMageCallsSuperUseHeroPower() throws Exception {
		...
		try {
			...
			for (int i = 0; i < stackTraceElement.length && !found; i++)
				if (stackTraceElement[i].getClassName().endsWith("Hero")
						&& stackTraceElement[i].getMethodName().equals("useHeroPower"))
					found = true;
			if (!found)
	...
	public void testPaladinUseHeroPowerNormaly() throws Exception {
		...
		assertEquals("The minion summoned by useHeroPower in class Paladin should be named properly.",
				"Silver Hand Recruit", silverHandRecruit.getName());
		assertEquals(
				"The minion summoned by useHeroPower in class Paladin should be assigned the right amount of attack.",
				1, silverHandRecruit.getAttack());
		assertEquals(
				"The minion summoned by useHeroPower in class Paladin should be assigned the right amount of max HP.",
				1, silverHandRecruit.getMaxHP());
		assertEquals(
				"The minion summoned by useHeroPower in class Paladin should be assigned the right amount of current HP.",
				1, silverHandRecruit.getCurrentHP());
		assertEquals("The minion summoned by useHeroPower in class Paladin should be assigned the right rarity.",
				Rarity.BASIC, silverHandRecruit.getRarity());
		assertEquals("The minion summoned by useHeroPower in class Paladin should not be taunt.", false,
				silverHandRecruit.isTaunt());
		assertEquals("The minion summoned by useHeroPower in class Paladin should be sleeping.", true,
				silverHandRecruit.isSleeping());
		assertEquals("The minion summoned by useHeroPower in class Paladin should not be divine.", false,
				silverHandRecruit.isDivine());
	...
	@Test(timeout = 1000)
	public void testClassIsInterfaceMinionListener() throws ClassNotFoundException {
	...
	@Test(timeout = 1000)
	public void testClassIsInterfaceActionValidator() throws ClassNotFoundException {
		testIsInterface(Class.forName(actionValidatorPath));
	}

	@Test(timeout = 3000)
	public void testActionValidatorHasActionValidateHero() throws NotYourTurnException, ClassNotFoundException {
		testExistsInClass(Class.forName(actionValidatorPath), "validateTurn", true, void.class,
				Class.forName(heroPath));
	}

	@Test(timeout = 3000)
	public void testActionValidatorHasAttackValidateMinionVsHero() throws NotYourTurnException, TauntBypassException,
			InvalidTargetException, NotSummonedException, ClassNotFoundException {
		testExistsInClass(Class.forName(actionValidatorPath), "validateAttack", true, void.class,
				Class.forName(minionPath), Class.forName(heroPath));
	}

	@Test(timeout = 1000)
	public void testClassIsInterfaceGameListener() throws ClassNotFoundException {
		testIsInterface(Class.forName(gameListenerPath));
	}

	@Test(timeout = 3000)
	public void testGameListenerHasOnGameOver() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gameListenerPath), "onGameOver", true, void.class);
	}

	@Test(timeout = 1000)
	public void testInstanceVariableListenerInClassGameIsPresentAndIsPrivateGame() throws Exception {
	...
	@Test(timeout = 1000)
	public void testSetterLogicForInstanceVariableListenerInClassGame() throws Exception {
		...
		testSetterLogic(game, "listener", listener, listener, GameListener.class);
	}

	@Test(timeout = 3000)
	public void testGameHasValidateTurnHero() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "validateTurn", true, void.class, Hero.class);
	}

	@Test(timeout = 1000, expected = NotYourTurnException.class)
	public void testValidateTurnHeroThrowsNotYourTurnExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionNotInFieldOnMinionThrowsNotSummonedExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
		Hero testHero = (currentHero == hero1) ? hero2 : hero1;
		Minion attacker = new Minion("minionThatIsNotOnField", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionInHandOnMinionThrowsNotSummonedExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
		Hero testHero = (currentHero == hero1) ? hero2 : hero1;
		Minion attacker = new Minion("minionThatIsInHand", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
		testHero.getField().add(target);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionInHandAndInFieldOnMinionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	public void testValidateAttackMinionInFieldOnMinionNotInFieldThrowsNotSummonedExceptionInClassGame()
		...
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
		Minion attacker = new Minion("minionThatIsInHand", 1, Rarity.BASIC, 2, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
		currentHero.getField().add(attacker);
		try {
			game.validateAttack(attacker, target);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnMinionNotTauntThrowsTauntBypassExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
		...
		Minion attacker = new Minion("minionThatIsInHand", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target2 = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, true, false, true);
		currentHero.getField().add(attacker);
		testHero.getField().add(target);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnMinionTauntDoesntThrowTauntBypassExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
		Hero testHero = (currentHero == hero1) ? hero2 : hero1;
		Minion attacker = new Minion("minionThatIsInHand", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, true, false, true);
		Minion target2 = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, true, false, true);
		currentHero.getField().add(attacker);
		testHero.getField().add(target);
		testHero.getField().add(target2);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnMinionDoesntThrowTauntBypassExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		...
		Minion attacker = new Minion("minionThatIsInHand", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
		Minion target2 = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
		currentHero.getField().add(attacker);
		testHero.getField().add(target);
		testHero.getField().add(target2);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnMinionAttack0ThrowsCannotAttackException() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		...
		Hero currentHero = game.getCurrentHero();
		Hero testHero = (currentHero == hero1) ? hero2 : hero1;
		Minion attacker = new Minion("minionThatIsInHand", 0, Rarity.BASIC, 0, 10, false, false, true);
		Minion target = new Minion("minionToBeAttacked", 0, Rarity.BASIC, 2, 10, false, false, true);
		currentHero.getField().add(attacker);
		testHero.getField().add(target);
		try {
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnMinionAlreadyAttackedThrowsCannotAttackException() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
	...
	@Test(timeout = 3000)
	public void testGameHasValidaAttackMinionOnHero() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "validateAttack", true, void.class, Minion.class, Hero.class);
	}

	@Test(timeout = 1000)
	public void testValidateAttackMinionNotInFieldOnHeroThrowsNotSummonedExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnHerowithTauntThrowsTauntBypassExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionInFieldOnHeroInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnHeroSleepingThrowsCannotAttackException() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		...
		Minion attacker = new Minion("minionThatIsInHand", 0, Rarity.BASIC, 2, 10, false, false, false);
		currentHero.getField().add(attacker);
		try {
			game.validateAttack(attacker, target);
	...
	@Test(timeout = 1000)
	public void testValidateAttackMinionOnHeroAlreadyAttackedThrowsCannotAttackException() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
	...
	@Test(timeout = 3000)
	public void testGameHasValidateManaCost() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "validateManaCost", true, void.class, Card.class);
	}

	@Test(timeout = 1000)
	public void testValidateCardManaCostThrowsNotEnoughManaExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 3000)
	public void testGameHasValidatePlayingMinion() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "validatePlayingMinion", true, void.class, Minion.class);
	}

	@Test(timeout = 1000)
	public void testValidatePlayingMinionThrowsFullFieldExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 1000)
	public void testValidatePlayingMinionDoesNOTThrowFullFieldExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 3000)
	public void testGameHasValidateUsingHeroPower() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "validateUsingHeroPower", true, void.class, Hero.class);
	}

	@Test(timeout = 1000)
	public void testValidateUsingHeroPowerDoesNOTThrowNotEnoughManaExceptionInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 1000)
	public void testValidateUsingHeroPowerThrowsHeroPowerAlreadyUsedInClassGame() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	@Test(timeout = 1000)
	public void testValidateUsingHeroPowerWorksNormally() throws Exception {
		Hero hero1 = new Hunter();
		Hero hero2 = new Hunter();
		Game game = new Game(hero1, hero2);
		Hero currentHero = game.getCurrentHero();
	...
	public void testGameHasOnHeroDeath() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "onHeroDeath", true, void.class);
	}
	...
	public void testGameHasDamageOpponent() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "damageOpponent", true, void.class, int.class);
	}
	...
	public void testGameDamageOpponentCallsHeroSetHp() throws Exception {
		Hero hero1 = new Hunter() {
			...
			public void setCurrentHP(int hp) {
				if (hp != 29)
					fail("The method damageOpponent in class Game should call setCurrentHp in class Hero with the correct amount not "
							+ (30 - hp));
				callParameters.add(this);
			}
		};
	...
	public void testGameHasEndTurn() throws ClassNotFoundException {
		testExistsInClass(Class.forName(gamePath), "endTurn", true, void.class);
	}
	...
	@Test(timeout = 1000)
	public void testInstanceVariableListenerInClassHeroIsPresentAndIsPrivateGame() throws Exception {
	...
	@Test(timeout = 1000)
	public void testSetterForInstanceVariableListenerExistsInClassHero() throws Exception {
		testSetterMethodExistsInClass(Class.forName(heroPath), "setListener", HeroListener.class, true);
	}

	@Test(timeout = 1000)
	public void testSetterLogicForInstanceVariableListenerInClassHero() throws Exception {
		...
		testSetterLogic(hero, "listener", listener, listener, HeroListener.class);
	}

	@Test(timeout = 1000)
	public void testGetterForInstanceVariableListenerExistsInClassHero() throws Exception {
		testGetterMethodExistsInClass(Class.forName(heroPath), "getListener", HeroListener.class, true);
	}

	@Test(timeout = 1000)
	public void testGetterLogicForInstanceVariableListenerInClassHero() throws Exception {
		Hero hero = new Hunter();
		HeroListener listener = new HeroListener() {
	...
	@Test(timeout = 1000)
	public void testInstanceVariableValidatorInClassHeroIsPresentAndIsPrivateGame() throws Exception {
	...
	@Test(timeout = 1000)
	public void testSetterForInstanceVariableValidatorExistsInClassHero() throws Exception {
		testSetterMethodExistsInClass(Class.forName(heroPath), "setValidator", ActionValidator.class, true);
	}

	@Test(timeout = 1000)
	public void testSetterLogicForInstanceVariableValidatorInClassHero() throws Exception {
		Hero hero = new Hunter();
		ActionValidator validator = new ActionValidator() {
			@Override
			public void validateTurn(Hero user) throws NotYourTurnException {
			...
			@Override
			public void validateAttack(Minion a, Minion t)
					throws CannotAttackException, TauntBypassException, InvalidTargetException, NotSummonedException {
			}

			@Override
			public void validateAttack(Minion m, Hero t)
					throws CannotAttackException, TauntBypassException, NotSummonedException, InvalidTargetException {
			}
		...
		testSetterLogic(hero, "validator", validator, validator, ActionValidator.class);
	}

	@Test(timeout = 3000)
	public void testGameHasOnMinionDeath() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "onMinionDeath", true, void.class, Minion.class);
	}
	...
	public void testHeroHasUseHeroPower() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "useHeroPower", true, void.class);
	}
	...
	public void testHeroHasPlayMinion() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "playMinion", true, void.class, Minion.class);
	}
	...
	public void testHeroHasAttackWithMinionOnMinion() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "attackWithMinion", true, void.class, Minion.class, Minion.class);
	}

	@Test(timeout = 3000)
	public void testHeroHasAttackWithMinionOnHero() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "attackWithMinion", true, void.class, Minion.class, Hero.class);
	}
	...
	public void testHeroAttackWithMinionOnMinionCallsValidateAttack() throws Exception {
		...
		if (!(callParameters.contains(validator) && callParameters.contains(attacker)
				&& callParameters.contains(target))) {
			reset();
	...
	public void testHeroHasEndTurn() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "endTurn", true, void.class);
	}
	...
	public void testHeroHasDrawCard() throws ClassNotFoundException {
		testExistsInClass(Class.forName(heroPath), "drawCard", true, Card.class);
	}
	...
	public void testHeroDrawCardFatigueLogic() throws Exception {
		...
		assertEquals(
				"The method drawCard should update the fatigueDamage variable in class Hero correctly if the deck no longer contains cards",
				correctFatigueValues, testFatigueValues);
		assertEquals(
				"The method drawCard should update the currentHP variable in class Hero correctly if the deck no longer contains cards",
				correctHeroHPValues, testHeroHPValues);
